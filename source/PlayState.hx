...
class PlayState extends MusicBeatState
{
	...
	var santa:FlxSprite;
	var defaultBoyFriendX:Float = 770;
	var defaultBoyFriendY:Float = 100;
	...
	public static var composerPauseText:String = '';
	...
	override public function create()
	{
		...
		var prototypeText:FlxText = new FlxText(5, FlxG.height - 18, 0, "v" + Application.current.meta.get('version') + "(FU23Ul34k) PROTOTYPE", 12);
		prototypeText.scrollFactor.set();
		prototypeText.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(prototypeText);
		...
		// UI_camera.zoom = 1;
			...
			{
			composerPauseText = 'Kawai Sprite';
			}
			/*
			else if (Song.song == 'erect-???')
			{
             composerPauseText = '???';
			}
			*/
